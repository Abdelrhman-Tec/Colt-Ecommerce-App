...
class Error<T> implements CategoriesState<T> {
...
@override
String toString() {
  return 'CategoriesState<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CategoriesStateCopyWith<T, $Res> {

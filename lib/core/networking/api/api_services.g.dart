...
class _ApiServices implements ApiServices {
  ...
  @override
  Future<List<CategoriesResponseModel>> getAllCategories() async {
  ...
  Future<List<ProductsResponseModel>> getAllProducts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ProductsResponseModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ProductsResponseModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
